...
<head>
    ...
    <title><?php echo $site_title; ?> - Dedicated Servers</title>
...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        <div id="page_content_inner">
			...
			<h4 class="heading_a uk-margin-bottom">Dedicated Servers (<a href="newdedi.php">Add New</a>)</h4>
                ...
                <div class="md-card-content">
                    <div class="uk-overflow-container">
                        <table class="uk-table">
                            ...
                            <tbody>
	                           <?php
															$GetServers = $odb -> prepare("SELECT * FROM `dedicateds` ORDER BY `id` DESC LIMIT 100");
															$GetServers -> execute();
															while ($getInfo = $GetServers -> fetch(PDO::FETCH_ASSOC))
															{
																...
																$name = $getInfo['name'];
																$nextpayment = date("d-m-Y h:i:s A", $getInfo['nextpayment']);
																echo '
																<tr>
																	<td>'.$ipaddr.'</td>
																	<td>'.$username.' </td>
																	<td>'.$name.'</td>
																	<td>'.$nextpayment.'</td>
																	<td><a class="md-btn md-btn-primary" href="viewdserver.php?id='.$id.'">View</a></td>
																</tr>';
															}
														?>
                            </tbody>
